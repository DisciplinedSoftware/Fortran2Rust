...
extern "C" {{
    fn {fn_ext}(
        transa: *mut i8, transb: *mut i8,
        m: *mut i32, n: *mut i32, k: *mut i32,
        alpha: *mut {rtype}, a: *mut {rtype}, lda: *mut i32,
        b: *mut {rtype}, ldb: *mut i32,
        beta: *mut {rtype}, c: *mut {rtype}, ldc: *mut i32,
        transa_len: i32, transb_len: i32,
    ) -> i32;
}}
